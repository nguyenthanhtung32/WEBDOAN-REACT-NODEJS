        ...
        <div className={styles.product}>
          ...
          <div className={styles.product_details}>
            ...
            <h3 className={styles.h3}>
              Giá :
              <span style={{ color: "#ff3300", fontWeight: "bold" , marginLeft :"5px"}}>
                {numeral(
            ...
            <div className={styles.cta} >
              <div className={`${styles.btn} ${styles.btn_primary}`} style={{marginRight : "10px"}} onClick={handleAddToCart}>
